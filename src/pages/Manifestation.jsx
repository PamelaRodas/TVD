...
const growthPrompts = [
  ...
  "How can I serve others better this week?",
  "What is one action I can take right now?",
];
  ...
  return (
    <section className="manifestation-section section">
      ...
      <div className="growth-progress-panel">
        ...
        <div><span className="diary-label">weekly checks</span><strong>{completedDays}/7</strong></div>
      ...
      <div className="manifestation-steps">
        ...
        <div className="steps-grid">
          <div className="step-card"><div className="step-number">1</div><h4>clarity</h4><p>define a clear goal with a real deadline.</p></div>
          <div className="step-card"><div className="step-number">2</div><h4>discipline</h4><p>work daily on small actions, even when motivation is low.</p></div>
          ...
          <div className="step-card"><div className="step-number">4</div><h4>gratitude</h4><p>thank God for progress and lessons as you move forward.</p></div>
        </div>
      </div>
      ...
      <div className="rituals-section">
        ...
        <div className="rituals-grid">
          ...
          <div className="ritual-card"><span className="ritual-icon">02</span><h4>intentional writing</h4><p>write what you learned, what you need and what you'll do today.</p></div>
          <div className="ritual-card"><span className="ritual-icon">03</span><h4>silent reflection</h4><p>take a few minutes in silence to reset your mind and priorities.</p></div>
          <div className="ritual-card"><span className="ritual-icon">04</span><h4>service mindset</h4><p>find a concrete way to help someone each day.</p></div>
        </div>
      </div>
