...
const journeyMoments = [
  ...
  },
  {
    ...
    verse: 'Matthew 5:16',
    reflection: 'Growth goes deeper when it also blesses someone else.',
    action: 'Perform a practical act of kindness today without expecting recognition.',
    image: 'https://i.pinimg.com/1200x/f4/1c/17/f41c1752e32705d47a42fe0efdc79185.jpg'
  },
  {
    id: 'purpose',
    step: '04',
    title: 'purpose station',
  ...
  return (
    <section id="about-me" className="section about-section">
      <div className="section-heading">
        ...
        <h2>driven by faith, intentional and committed to growth</h2>
      </div>
      ...
      <div className="about-grid">
        <article className="about-card profile-card">
          ...
          <h3>rooted in faith, focused on progress</h3>
          <p>
            I believe in growing with responsibility, gratitude and faith in God.
            This space helps me stay intentional, reflect often and continue moving forward with purpose.
          </p>
          <div className="profile-stats">
            <span><strong>vibe:</strong> calm, focused, grateful</span>
        ...
        <article className="about-card quote-card">
          ...
          <p>
            This space is a reminder that small daily choices create a meaningful life.
            With faith, discipline and gratitude, growth becomes constant and real.
          </p>
